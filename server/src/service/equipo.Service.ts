...
const listAllEquipos = async () => {
  console.log("Ejecutando sp_listar_equipos sin parámetros");
  
  try {
    const [results]: any = await cn
      .promise()
      .query("CALL sp_listar_equipos()"); // Sin parámetros

    console.log("Resultados de sp_listar_equipos:", { data: results[0] });
...
export { listEquipos, createEquipo, updateEquipo, deleteEquipo, listAllEquipos };
