...
routerProducto.post('/productoAdd', ReglasValidacionProducto, validate, addProductCTRL);

// Actualizar un producto existente
routerProducto.put('/productoUpadte', ReglasValidacionProducto, validate, updateProductCTRL);

// Eliminar un producto
routerProducto.delete('/productosDelete/:id', deleteProductCTRL);
